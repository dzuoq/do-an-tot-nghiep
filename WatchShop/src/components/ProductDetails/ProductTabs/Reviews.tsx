...
const Reviews: React.FC<any> = ({ product }) => {
  ...
  const handleSubmitReview = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setIsSubmitting(true); // Bật trạng thái loading cho nút gửi
    try {
      await createReview(product.productId, user.userId, reviewText, rating);
      ...
      setIsSubmitting(false); // Tắt trạng thái loading sau khi hoàn tất
    }
  };
        ...
        <div className="review-area">
          ...
          <div className="submit-review-btn">
            <input
              ...
              style={{
                backgroundColor: isSubmitting ? "#ccc" : "#80001C", // Đổi màu nút khi đang gửi
        ...
        {loading ? (
          ...
          reviews.map((review: any) => (
            ...
            >
              ...
              >
                <strong>
                  {review.fullName} ({maskPhoneNumber(review.phoneNumber)})
                </strong>
                <span>
