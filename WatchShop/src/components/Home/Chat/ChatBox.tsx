...
const ChatBox: React.FC<ChatBoxProps> = ({ onClose, messages, chatRoomId }) => {
  ...
  const handleSendMessage = async () => {
    if (inputMessage.trim() !== "" && stompClient) {
      ...
      // Gửi tin nhắn của người dùng qua WebSocket
      stompClient.send(`/app/chat.sendMessage`, {}, JSON.stringify(newMsgData));
      ...
      // Kiểm tra nếu tin nhắn có chứa "@AI"
        ...
        try {
          const aiResponse = await axios.post(
            "https://api.openai.com/v1/chat/completions",
            {
              ...
              messages: [
                { role: "user", content: inputMessage.replace("@AI", "") },
              ],
              max_tokens: 800,
            },
            {
              headers: {
                ...
                Authorization: `Bearer KEY`, // Thay YOUR_OPENAI_API_KEY bằng API key của bạn
              },
            }
          );
          ...
          // Thêm tin nhắn từ ChatGPT vào danh sách tin nhắn
          setMsgList((prevMsgList) => [...prevMsgList, botMessage]);

          // Gửi tin nhắn của AI qua WebSocket
          stompClient.send(
    ...
    <div style={styles.chatContainer}>
      ...
      <div style={styles.inputContainer}>
        <Input
          ...
          placeholder="Đặt câu hỏi hoặc @AI để hỏi chatbot"
          style={styles.input}
