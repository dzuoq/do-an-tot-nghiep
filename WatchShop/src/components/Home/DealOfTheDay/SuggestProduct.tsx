...
import { getFilteredProducts, getSuggestedProducts } from "../../../services/productService"; // Giả sử API này được đặt ở đây

const SuggestProduct: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = await getSuggestedProducts();
        setProducts(filteredProducts.payload); // Cập nhật state
