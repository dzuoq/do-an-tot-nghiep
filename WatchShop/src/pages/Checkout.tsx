...
const Checkout: React.FC = () => {
  ...
  const handleAddressChange = (value: any) => {
    ...
    if (selectedAddr) {
      ...
      localStorage.setItem("selectedAddressBookId", selectedAddr.addressBookId);
    }
  };
                ...
                renderItem={(address) => (
                  ...
                  >
                    <Row style={{ width: "100%" }} align="middle">
                      <Col span={20}>
                        <Radio
                          value={address.addressBookId}
                          checked={
                            selectedAddress?.addressBookId ===
                            address.addressBookId
                          }
                          onChange={() =>
                            handleAddressChange(address.addressBookId)
                          }
                        >
