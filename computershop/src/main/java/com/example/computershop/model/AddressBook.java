...
public class AddressBook {
    ...
    public AddressBook(User user, String recipientName, String phoneNumber, String address, String ward,
            String district, String city, String email) { // Cập nhật constructor
        this.user = user;
